...
- Source: http://a.ml/vocabularies/amf/validation#example-validation-error
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/examples/min-max-properties-example.raml#/declarations/types/InvalidMax/example/badMax
  Property: file://amf-cli/shared/src/test/resources/validations/examples/min-max-properties-example.raml#/declarations/types/InvalidMax/example/badMax
