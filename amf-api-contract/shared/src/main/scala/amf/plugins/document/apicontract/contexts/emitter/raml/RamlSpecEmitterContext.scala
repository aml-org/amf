...
import amf.plugins.document.apicontract.parser.spec.declaration.emitters.annotations._
...
import amf.plugins.domain.apicontract.models.{EndPoint, Operation, Parameter, Response}
