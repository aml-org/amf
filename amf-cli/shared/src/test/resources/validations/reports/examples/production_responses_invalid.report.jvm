...
- Source: http://a.ml/vocabularies/amf/parser#closed-shape
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/production/responses-invalid.raml#/web-api/endpoint/end-points/%2Ftest%2F%7Bid%7D/supportedOperation/patch/returns/resp/body
  Property: 
