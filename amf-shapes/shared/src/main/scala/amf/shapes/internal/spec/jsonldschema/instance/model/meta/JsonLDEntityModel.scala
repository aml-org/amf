...
import amf.shapes.internal.spec.jsonldschema.instance.model.domain.JsonLDObject

class JsonLDEntityModel(val `type`: List[ValueType], val fields: List[Field]) extends ModelDefaultBuilder {
