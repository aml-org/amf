...
import amf.agentsdomain.client.scala.{
  AgentsDomainBaseUnitClient => InternalAgentsDomainBaseUnitClient,
  AgentsDomainConfiguration => InternalAgentsDomainConfiguration
}
import amf.agentsdomain.internal.convert.AgentsDomainClientConverters._
...
@JSExportAll
class AgentsDomainConfiguration private[amf] (private[amf] override val _internal: InternalAgentsDomainConfiguration)
    extends BaseAgentsDomainConfiguration(_internal) {

  /** Contains common AMF graph operations associated to documents */
  override def baseUnitClient(): AMLBaseUnitClient = new AgentsDomainBaseUnitClient(new InternalAgentsDomainBaseUnitClient(_internal))
  ...
  /** Set the configuration [[ResourceLoader]]s
    ...
    */
  override def withResourceLoaders(rl: ClientList[ResourceLoader]): AgentsDomainConfiguration =
  ...
  /** Add an [[AMFEventListener]]
    ...
    */
  override def withEventListener(listener: AMFEventListener): AgentsDomainConfiguration =
  ...
  /** Register a Dialect
    ...
    */
  override def withDialect(dialect: Dialect): AgentsDomainConfiguration = _internal.withDialect(dialect)
  ...
  /** Register a Dialect
    ...
    */
  def withDialect(url: String): ClientFuture[AgentsDomainConfiguration] = _internal.withDialect(url).asClient
  ...
  /** Set [[BaseExecutionEnvironment]]
    ...
    */
  override def withExecutionEnvironment(executionEnv: BaseExecutionEnvironment): AgentsDomainConfiguration =
  ...
  /** Register a [[Dialect]] linked from a [[DialectInstance]]
    ...
    *   A CompletableFuture of [[AgentsDomainConfiguration]]
    */
  def forInstance(url: String): ClientFuture[AgentsDomainConfiguration] = _internal.forInstance(url).asClient

  override def withShapePayloadPlugin(plugin: AMFShapePayloadValidationPlugin): AgentsDomainConfiguration =
...
@JSExportAll
@JSExportTopLevel("AgentsDomainConfiguration")
object AgentsDomainConfiguration {

  def AgentsDomain(): AgentsDomainConfiguration = new AgentsDomainConfiguration(InternalAgentsDomainConfiguration.AgentsDomain())
