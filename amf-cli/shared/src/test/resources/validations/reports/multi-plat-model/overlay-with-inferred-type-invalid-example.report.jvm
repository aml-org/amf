Model: file://amf-cli/shared/src/test/resources/validations/overlays/overlay-with-inferred-type-invalid-example/base.raml
Profile: RAML 1.0
Conforms? false
Number of results: 1
...
- Source: http://a.ml/vocabularies/amf/validation#example-validation-error
  Message: /id expected maxLength: 3, actual: 4
  Level: Violation
