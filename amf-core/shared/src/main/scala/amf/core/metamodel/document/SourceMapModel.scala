...
object SourceMapModel extends Obj {
  ...
  val Element = Field(Str, SourceMaps + "element", ModelDoc(ModelVocabularies.AmlDoc, "element", "Label indicating the type of source map information"))

  val Value = Field(Str, SourceMaps + "value", ModelDoc(ModelVocabularies.AmlDoc, "value", "Value for the source map."))
