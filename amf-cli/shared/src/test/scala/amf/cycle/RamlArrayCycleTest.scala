...
class RamlArrayCycleTest extends FunSuiteCycleTests {
  ...
  multiGoldenTest("Type expression and explicit array must be parsed similarly",
  ...
  multiGoldenTest("Union type expression is parsed similar to explicit union array",
  ...
  multiGoldenTest("Matrix type expression and explicit matrix must be parsed similarly",
