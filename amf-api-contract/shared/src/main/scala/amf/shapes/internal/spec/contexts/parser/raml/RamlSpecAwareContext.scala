...
import amf.shapes.internal.spec.contexts.{SpecAwareContext, SpecVersionFactory}
...
import amf.plugins.domain.apicontract.models.security.{SecurityScheme, WithSettings}
