...
object DialectModel extends DocumentModel with ExternalContextModel {
  ...
  val Name      = Field(Str, Namespace.Schema + "name", ModelDoc(ExternalModelVocabularies.SchemaOrg, "name", "Name of the dialect"))
  val Version   = Field(Str, Namespace.Schema + "version", ModelDoc(ExternalModelVocabularies.SchemaOrg, "version", "Version of the dialect"))
  val Documents = Field(DocumentsModelModel, Namespace.Meta + "documents", ModelDoc(ModelVocabularies.Meta, "documents", "Document mappint for the the dialect"))
