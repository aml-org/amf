...
class AstIndexTest extends FunSuite with Matchers with IndexHelper {
  ...
  test("Json Schema Draft 7 - $id resolution test") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/draft-7-spec-example.json"
    val expected = Seq(
      IndexResult("#"),
  ...
  test("Json Schema Draft 2019-09 - $id and $anchor resolution test") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/draft-2019-spec-example.json"
    val expected = Seq(
      IndexResult("#"),
  ...
  test("Scalar map") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/scalar-map.json"
    val expected = Seq(
      IndexResult("/"),
      IndexResult("/a"),
      IndexResult("/b")
  ...
  test("Small map") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/small-map.json"
    val expected = Seq(
      IndexResult("/"),
      IndexResult("/a"),
      IndexResult("/a/ax"),
  ...
  test("Entry with seq") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/entry-with-seq.json"
    val expected = Seq(
      IndexResult("/"),
      IndexResult("/a"),
      IndexResult("/a/0"),
  ...
  test("Inner array reference test") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/self-reference-in-array.json"
    val expected = Seq(
      IndexResult("/"),
      IndexResult("/items"),
      IndexResult("/items/0"),
  ...
  test("Inner seq elements by index") {
    val pathToFile = "amf-api-contract/shared/src/test/resources/ast-index/inner-seq-elements-by-index.json"
    val expected = Seq(
      IndexResult("/"),
      IndexResult("/seq"),
      IndexResult("/seq/0/a"),
