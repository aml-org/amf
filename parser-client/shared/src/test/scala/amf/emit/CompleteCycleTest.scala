...
class CompleteCycleTest extends BuildCycleTests {
  ...
  override val basePath = "parser-client/shared/src/test/resources/upanddown/"
  val base08Path        = "parser-client/shared/src/test/resources/upanddown/raml08/"
  ...
  val apiPath           = "parser-client/shared/src/test/resources/api/"
