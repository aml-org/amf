...
//        var B:Int = unHex(str.charAt(k + 1), str.charAt(k + 2))
...
//            ucs4Char = InvalidUtf8
//          else if (ucs4Char == 0xFFFE || ucs4Char == 0xFFFF)
//            ucs4Char = 0xFFFD
//
//          if (ucs4Char >= 0x10000) {
//            ucs4Char = ucs4Char - 0x10000
//            if (ucs4Char > 0xFFFFF) throw uriError
//            val H :Char = ((ucs4Char >>> 10) + 0xD800).toChar
...
//    }
//
//    if(buf == null) str else new String(buf, 0, bufTop)
//  }
