...
class RamlParserErrorTest extends ParserErrorTest {
    ...
    validate(
      ...
      erroneousTypeShape => {
        ...
        erroneousTypeShape.targetNode should be(
          "file://parser-client/shared/src/test/resources/parser-results/error/custom-facets.raml#/declarations/types/scalar/ErroneousType")
      ...
      incorrect1 => {
        ...
        incorrect1.targetNode should be(
          "file://parser-client/shared/src/test/resources/parser-results/error/custom-facets.raml#/declarations/types/union/Incorrect1")
      ...
      incorrect2 => {
        ...
        incorrect2.targetNode should be(
          "file://parser-client/shared/src/test/resources/parser-results/error/custom-facets.raml#/declarations/types/union/Incorrect2")
      ...
      incorrect3 => {
        ...
        incorrect3.targetNode should be(
          "file://parser-client/shared/src/test/resources/parser-results/error/custom-facets.raml#/declarations/types/union/Incorrect3")
  ...
  test("Bad ident flow array and map") {
    validate(
      "/valid/bad-ident-flow.raml"
    )
  }

  test("Bad ident flow map") {
    validate(
      "/valid/bad-ident-flow-map.raml"
    )
  }

  override protected val basePath: String = "file://parser-client/shared/src/test/resources/parser-results/"
