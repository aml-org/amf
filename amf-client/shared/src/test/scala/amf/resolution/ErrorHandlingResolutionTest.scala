    ...
    errorCycle(
      ...
      List(
        ErrorContainer(
          ...
          "file://amf-client/shared/src/test/resources/resolution/error-apis/bad-variable-replace/api.raml#/web-api/end-points/%2Fcatalogs/collection/applied/get/default-requirement/oauth_2_0",
          None,
