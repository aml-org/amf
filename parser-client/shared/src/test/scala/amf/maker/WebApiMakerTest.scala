...
trait WebApiMakerTest extends AsyncFunSuite with CompilerTestBuilder with ListAssertions with AmfObjectTestMatcher {
  ...
  val basePath = "file://parser-client/shared/src/test/resources/maker/"
  ...
  private def webApiWithDependencyTypes(): WebApi = {
    val api = WebApi()
      ...
      .withVersion("1.1")
      .withTermsOfService("terms of service")
      .withId("parser-client/shared/src/test/resources/maker/types-dependency.raml#/web-api")
  ...
  private def oasWebApiWithDependencyTypes(): WebApi = {
    val api = WebApi()
      ...
      .withVersion("1.1")
      .withTermsOfService("terms of service")
      .withId("parser-client/shared/src/test/resources/maker/types-dependency.json#/web-api")
