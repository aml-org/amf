...
class DialectInstancesValidationTest extends AsyncFunSuite with PlatformSecrets {
  ...
  val basePath       = "file://parser-client/shared/src/test/resources/vocabularies2/validation/"
  val productionPath = "file://parser-client/shared/src/test/resources/vocabularies2/production/ABOUT/"
