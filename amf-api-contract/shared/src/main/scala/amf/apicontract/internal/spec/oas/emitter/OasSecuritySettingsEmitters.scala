...
import amf.apicontract.internal.spec.raml.emitter.{RamlApiKeySettingsEmitters, RamlOAuth1SettingsEmitters}
...
import amf.plugins.document.apicontract.parser.spec.raml.emitters.RamlOAuth1SettingsEmitters
