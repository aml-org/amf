...
import amf.plugins.document.apicontract.contexts.parser.oas.{Oas2WebApiContext, Oas3WebApiContext}
...
import amf.plugins.document.apicontract.parser.spec.{SpecSyntax, toOas}
