...
import amf.core.client.scala.model.domain.{AmfArray, AmfScalar, DomainElement, NamedDomainElement, Shape}
import amf.core.internal.annotations.{AutoGeneratedName, ExplicitField, Inferred, LexicalInformation, SynthesizedField}
...
import amf.plugins.document.apicontract.parser.spec.declaration.{OasTypeParser, RamlTypeSyntax, StringDefaultType, _}
