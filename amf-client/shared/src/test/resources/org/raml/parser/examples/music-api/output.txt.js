...
discography[0].length should be multiple of 100
  ...
  Level: Violation
  Target: file://amf-client/shared/src/test/resources/org/raml/parser/examples/music-api/songs-library.raml#/declarations/types/Musician/examples/example/default-example
  Property: file://amf-client/shared/src/test/resources/org/raml/parser/examples/music-api/songs-library.raml#/declarations/types/Musician/examples/example/default-example
...
- Source: http://a.ml/vocabularies/amf/parser#unsupported-example-media-type-warning
  ...
  Level: Warning
  Target: file://amf-client/shared/src/test/resources/org/raml/parser/examples/music-api/input.raml#/web-api/end-points/%2Fsongs%2F%7BsongId%7D/get/200/application%2Fxml/schema/schema/examples/example/default-example
