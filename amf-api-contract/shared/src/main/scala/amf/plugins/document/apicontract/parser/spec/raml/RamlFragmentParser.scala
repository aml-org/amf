...
import amf.plugins.document.apicontract.parser.{RamlFragment, WebApiShapeParserContextAdapter}
    ...
    def parse(): SecuritySchemeFragment = {
      ...
      security.withEncodes(
        RamlSecuritySchemeParser(map,
                                 (security: amf.plugins.domain.apicontract.models.security.SecurityScheme) =>
