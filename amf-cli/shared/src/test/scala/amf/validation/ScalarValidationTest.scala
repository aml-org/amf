...
//import amf.core.client.scala.model.DataType.DateTimeOnly
//import amf.core.internal.metamodel.Type.{Date, DateTime}
...
//      .init()
//      .map(_ => {
//        ApiRegister.register(platform) // not sure why this fixes tests, but this will be deleted.
