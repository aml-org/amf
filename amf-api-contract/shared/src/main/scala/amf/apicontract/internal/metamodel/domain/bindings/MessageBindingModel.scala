...
object MessageBindingModel extends MessageBindingModel {
  ...
  override def modelInstance: AmfObject = throw new Exception("MessageBinding is an abstract class")
  ...
  override val doc: ModelDoc = ModelDoc(ModelVocabularies.ApiBinding, "MessageBinding")
}
