...
import amf.plugins.document.webapi.validation.ApiValidationProfiles.OAS_20_PROFILE
...
object Oas20Plugin extends OasPlugin {
  ...
  override def domainValidationProfiles: Seq[ValidationProfile] = Seq(OAS_20_PROFILE)
...
object Oas30Plugin extends OasPlugin {
  ...
  // TODO: Temporary, should be erased until synchronous validation profile building for dialects is implemented
  override def domainValidationProfiles: Seq[ValidationProfile] = Seq(ApiValidationProfiles.OAS_30_PROFILE)
