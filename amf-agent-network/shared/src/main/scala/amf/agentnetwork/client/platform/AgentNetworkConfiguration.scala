...
import amf.agentnetwork.client.scala.{
  AgentNetworkBaseUnitClient => InternalAgentNetworkBaseUnitClient,
  AgentNetworkConfiguration => InternalAgentNetworkConfiguration
}
import amf.agentnetwork.internal.convert.AgentNetworkClientConverters._
...
@JSExportAll
class AgentNetworkConfiguration private[amf] (private[amf] override val _internal: InternalAgentNetworkConfiguration)
    extends BaseAgentNetworkConfiguration(_internal) {

  /** Contains common AMF graph operations associated to documents */
  override def baseUnitClient(): AMLBaseUnitClient = new AgentNetworkBaseUnitClient(new InternalAgentNetworkBaseUnitClient(_internal))
  ...
  /** Set the configuration [[ResourceLoader]]s
    ...
    */
  override def withResourceLoaders(rl: ClientList[ResourceLoader]): AgentNetworkConfiguration =
  ...
  /** Register a Dialect
    ...
    */
  override def withDialect(dialect: Dialect): AgentNetworkConfiguration = _internal.withDialect(dialect)
  ...
  /** Register a Dialect
    ...
    */
  def withDialect(url: String): ClientFuture[AgentNetworkConfiguration] = _internal.withDialect(url).asClient
  ...
  /** Set [[BaseExecutionEnvironment]]
    ...
    */
  override def withExecutionEnvironment(executionEnv: BaseExecutionEnvironment): AgentNetworkConfiguration =
  ...
  /** Register a [[Dialect]] linked from a [[DialectInstance]]
    ...
    *   A CompletableFuture of [[AgentNetworkConfiguration]]
    */
  def forInstance(url: String): ClientFuture[AgentNetworkConfiguration] = _internal.forInstance(url).asClient

  override def withShapePayloadPlugin(plugin: AMFShapePayloadValidationPlugin): AgentNetworkConfiguration =
...
@JSExportAll
@JSExportTopLevel("AgentNetworkConfiguration")
object AgentNetworkConfiguration {

  def AgentNetwork(): AgentNetworkConfiguration = new AgentNetworkConfiguration(InternalAgentNetworkConfiguration.AgentNetwork())
