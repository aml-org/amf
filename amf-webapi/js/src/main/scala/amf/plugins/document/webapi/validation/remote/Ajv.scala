...
object AjvValidator {
  private lazy val options = js.JSON.parse("{\"schemaId\":\"id\"}").asInstanceOf[js.Object]

  def apply(): Ajv = {
    js.Dynamic.newInstance(nativeAjv)(options).asInstanceOf[Ajv]
      .addMetaSchema(Draft4MetaSchema.instance)
      .addFormat("RFC2616", "^((Mon|Tue|Wed|Thu|Fri|Sat|Sun), [0-9]{2} (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) [0-9]{4} [0-9]{2}:[0-9]{2}:[0-9]{2} GMT)$")
