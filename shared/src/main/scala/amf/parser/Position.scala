...
case class Position(line: Int, column: Int) {
    ...
    def min(other: Position): Position = if (line < other.line || line == other.line && column <= other.column) this else other

    /* Return max position between actual and given. */
    def max(other: Position): Position = if (line > other.line || line == other.line && column >= other.column) this else other
