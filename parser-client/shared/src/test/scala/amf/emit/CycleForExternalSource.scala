...
class CycleForExternalSource extends BuildCycleTests {
  ...
  val jsonPath = "parser-client/shared/src/test/resources/production/othercases/jsonschema/"
  val xsdPath  = "parser-client/shared/src/test/resources/production/othercases/xsdschema/"
  ...
  test("Test ext example xsd raml to jsonld") {
    cycle(
      ...
      RamlYamlHint,
      Amf,
      "parser-client/shared/src/test/resources/production/othercases/xsdexample/"
    )
  }
