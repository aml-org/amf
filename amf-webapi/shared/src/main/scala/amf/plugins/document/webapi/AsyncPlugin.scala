...
import amf.plugins.document.webapi.validation.ApiValidationProfiles.ASYNC_20_PROFILE
...
object Async20Plugin extends AsyncPlugin {
  ...
  override def domainValidationProfiles: Seq[ValidationProfile] = Seq(ASYNC_20_PROFILE)
}
