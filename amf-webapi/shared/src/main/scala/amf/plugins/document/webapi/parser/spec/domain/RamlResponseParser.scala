...
import amf.plugins.document.webapi.annotations.{AutoGeneratedName, EmptyPayload}
              ...
              case YType.Null =>
                ctx.factory
                  ...
                  .foreach { schema =>
                    ...
                    payloads += payload.withSchema(schema.add(AutoGeneratedName()))
                  }
              ...
              case YType.Str =>
                ctx.factory
                  .typeParser(entry,
                              ...
                              defaultType)
                  .parse()
                  .foreach(s => payloads += payload.withSchema(s.add(AutoGeneratedName())))
                res.set(RequestModel.Payloads, AmfArray(payloads, Annotations(entry.value)), Annotations(entry))
                        ...
                        ctx.factory
                          ...
                          .foreach { schema =>
                            ...
                            payloads += payload
                              ...
                              .withSchema(tracking(schema.add(AutoGeneratedName()), payload.id))
                          }
                      } else {
