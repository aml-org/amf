...
import amf.apicontract.internal.spec.common.parser.{AbstractDeclarationsParser, OasLikeSecurityRequirementParser, SpecParserOps, WebApiBaseSpecParser, WebApiShapeParserContextAdapter}
