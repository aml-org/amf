...
case class FederationMetadataParser[T <: FederationMetadata](ast: Node, target: HasFederationMetadata[T], basePath: Seq[String], factory: FederationMetadataFactory[T])(implicit val ctx: GraphQLFederationWebApiContext
