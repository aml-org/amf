...
import amf.core.client.scala.model.domain.{AmfArray, AmfScalar, DomainElement, Linkable, NamedDomainElement}
...
import amf.plugins.domain.apicontract.metamodel.bindings.BindingType
