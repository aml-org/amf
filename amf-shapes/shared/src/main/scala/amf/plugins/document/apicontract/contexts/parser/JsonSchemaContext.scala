...
import amf.core.parser.{FragmentRef, FutureDeclarations, ParsedReference, ParserContext, SearchScope}
import amf.core.remote.{JsonSchemaDialect, Vendor}
...
import amf.plugins.document.apicontract.parser.{RamlExternalSchemaExpressionFactory, ShapeParserContext}
import amf.plugins.document.apicontract.parser.spec.SpecSyntax
import amf.plugins.document.apicontract.parser.spec.declaration.{DefaultType, JSONSchemaDraft4SchemaVersion, JSONSchemaVersion, RamlTypeParser, SchemaVersion, TypeInfo}
import amf.plugins.document.apicontract.parser.spec.declaration.common.YMapEntryLike
import amf.plugins.document.apicontract.parser.spec.jsonschema.{AstIndex, AstIndexBuilder, JsonSchemaInference, JsonSchemaParser}
