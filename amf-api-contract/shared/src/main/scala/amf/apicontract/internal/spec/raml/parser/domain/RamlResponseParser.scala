          ...
          entry => {
            ...
            entry.value.tagType match {
              case YType.Null =>
                ctx.factory
                  .typeParser(entry,
                              shape => tracking(shape.withName("default"), payload),
                              false,
                              defaultType)
                  .parse()
                  .foreach { schema =>
                ...
                res.setWithoutId(RequestModel.Payloads, AmfArray(payloads, Annotations(entry.value)), Annotations(entry))
                      ...
                      if (payloads.isEmpty) {
                        ctx.factory
                          ...
                          .foreach { schema =>
                            ...
                            payload.setWithoutId(PayloadModel.Schema, tracking(schema, payload), Annotations(entry.value))
                          }
                      } else {
