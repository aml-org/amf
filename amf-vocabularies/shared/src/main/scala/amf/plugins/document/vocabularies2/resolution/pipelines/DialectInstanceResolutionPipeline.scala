package amf.plugins.document.vocabularies2.resolution.pipelines
...
import amf.plugins.document.vocabularies2.resolution.stages.DialectInstanceReferencesResolutionStage
