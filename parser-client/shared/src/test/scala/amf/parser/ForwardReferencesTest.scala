...
class ForwardReferencesTest extends AsyncFunSuite with PlatformSecrets {
  ...
  private val referencesPath = "file://parser-client/shared/src/test/resources/references/"
  private val basePath       = "file://parser-client/shared/src/test/resources/upanddown/"
    ...
    validate(
      ...
      undefined => {
        ...
        undefined.message should be(
          "Unresolved reference 'UndefinedType' from root context file://parser-client/shared/src/test/resources/upanddown/forward-references-types-error.raml")
  ...
  test("Test reference not found exception on expression") {
    validate(
      ...
      undefined => {
        undefined.level should be("Violation")
        undefined.message should be(
          "Unresolved reference 'UndefinedType' from root context file://parser-client/shared/src/test/resources/upanddown/forward-references-types-error-expression.raml")
  ...
  test("Test reference not found exception on array") {
    validate(
      ...
      undefined => {
        undefined.level should be("Violation")
        undefined.message should be(
          "Unresolved reference 'UndefinedType' from root context file://parser-client/shared/src/test/resources/upanddown/forward-references-types-error-array.raml")
  ...
  test("Test complex contexts") {
    validate(
      ...
      a => {
        ...
        a.message should be(
          "Unresolved reference 'A' from root context file://parser-client/shared/src/test/resources/references/contexts/library.raml")
        a.position.map(_.range) should be(Some(Range((4, 5), (4, 6))))
      },
      c => {
        c.level should be("Violation")
        c.message should be(
          "Unresolved reference 'C' from root context file://parser-client/shared/src/test/resources/references/contexts/nested.raml")
