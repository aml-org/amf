...
class SemanticJsonSchemaConfiguration private[amf] (
  ...
  /**
    ...
    * @return [[SemanticJsonSchemaConfiguration]] with [[AMFEventListener]] added
    */
  ...
  /**
    ...
    * @return [[SemanticJsonSchemaConfiguration]] with [[Dialect]] registered
    */
  ...
  /**
    ...
    * @return A CompletableFuture of [[SemanticJsonSchemaConfiguration]]
    */
