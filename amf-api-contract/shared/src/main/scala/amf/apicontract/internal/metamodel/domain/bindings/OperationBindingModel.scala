...
object OperationBindingModel extends OperationBindingModel {
  ...
  override def modelInstance: AmfObject = throw new Exception("OperationBinding is an abstract class")
  ...
  override val doc: ModelDoc = ModelDoc(ModelVocabularies.ApiBinding, "OperationBinding")
}
