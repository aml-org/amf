...
import amf.othercard.client.scala.{
  OtherCardBaseUnitClient => InternalOtherCardBaseUnitClient,
  OtherCardConfiguration => InternalOtherCardConfiguration
}
import amf.othercard.internal.convert.OtherCardClientConverters._
...
@JSExportAll
class OtherCardConfiguration private[amf] (private[amf] override val _internal: InternalOtherCardConfiguration)
    extends BaseOtherCardConfiguration(_internal) {

  /** Contains common AMF graph operations associated to documents */
  override def baseUnitClient(): AMLBaseUnitClient = new OtherCardBaseUnitClient(new InternalOtherCardBaseUnitClient(_internal))
  ...
  /** Set the configuration [[ResourceLoader]]s
    ...
    */
  override def withResourceLoaders(rl: ClientList[ResourceLoader]): OtherCardConfiguration =
  ...
  /** Register a Dialect
    ...
    */
  override def withDialect(dialect: Dialect): OtherCardConfiguration = _internal.withDialect(dialect)
  ...
  /** Register a Dialect
    ...
    */
  def withDialect(url: String): ClientFuture[OtherCardConfiguration] = _internal.withDialect(url).asClient
  ...
  /** Set [[BaseExecutionEnvironment]]
    ...
    */
  override def withExecutionEnvironment(executionEnv: BaseExecutionEnvironment): OtherCardConfiguration =
  ...
  /** Register a [[Dialect]] linked from a [[DialectInstance]]
    ...
    *   A CompletableFuture of [[OtherCardConfiguration]]
    */
  def forInstance(url: String): ClientFuture[OtherCardConfiguration] = _internal.forInstance(url).asClient

  override def withShapePayloadPlugin(plugin: AMFShapePayloadValidationPlugin): OtherCardConfiguration =
...
@JSExportAll
@JSExportTopLevel("OtherCardConfiguration")
object OtherCardConfiguration {

  def OtherCard(): OtherCardConfiguration = new OtherCardConfiguration(InternalOtherCardConfiguration.OtherCard())
