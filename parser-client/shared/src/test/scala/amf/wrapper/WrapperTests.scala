...
trait WrapperTests extends AsyncFunSuite with Matchers with NativeOps {
  ...
  private val banking       = "file://parser-client/shared/src/test/resources/production/banking-api/api.raml"
  private val zencoder      = "file://parser-client/shared/src/test/resources/api/zencoder.raml"
  private val zencoder08    = "file://parser-client/shared/src/test/resources/api/zencoder08.raml"
  private val music         = "file://parser-client/shared/src/test/resources/production/world-music-api/api.raml"
  private val demosDialect  = "file://parser-client/shared/src/test/resources/api/dialects/eng-demos.raml"
  private val demos2Dialect = "file://parser-client/shared/src/test/resources/api/dialects/eng-demos-2.raml"
  private val demosInstance = "file://parser-client/shared/src/test/resources/api/examples/libraries/demo.raml"
  private val security      = "file://parser-client/shared/src/test/resources/upanddown/unnamed-security-scheme.raml"
  private val amflight =
    "file://parser-client/shared/src/test/resources/production/american-flight-api-2.0.1-raml/api.raml"
  private val defaultValue = "file://parser-client/shared/src/test/resources/api/shape-default.raml"
  private val profile      = "file://parser-client/shared/src/test/resources/api/validation/custom-profile.raml"
  //  private val banking       = "file://parser-client/shared/src/test/resources/api/banking.raml"
  private val aml_doc = "file://vocabularies/vocabularies/aml_doc.raml"
  private val scalarAnnotations =
    "file://parser-client/shared/src/test/resources/org/raml/parser/annotation/scalar-nodes/input.raml"
