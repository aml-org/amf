...
import amf.agentfabric.client.scala.{
  AgentFabricBaseUnitClient => InternalAgentFabricBaseUnitClient,
  AgentFabricConfiguration => InternalAgentFabricConfiguration
}
import amf.agentfabric.internal.convert.AgentFabricClientConverters._
...
@JSExportAll
class AgentFabricConfiguration private[amf] (private[amf] override val _internal: InternalAgentFabricConfiguration)
    extends BaseAgentFabricConfiguration(_internal) {

  /** Contains common AMF graph operations associated to documents */
  override def baseUnitClient(): AMLBaseUnitClient = new AgentFabricBaseUnitClient(new InternalAgentFabricBaseUnitClient(_internal))
  ...
  /** Set the configuration [[ResourceLoader]]s
    ...
    */
  override def withResourceLoaders(rl: ClientList[ResourceLoader]): AgentFabricConfiguration =
  ...
  /** Add an [[AMFEventListener]]
    ...
    */
  override def withEventListener(listener: AMFEventListener): AgentFabricConfiguration =
  ...
  /** Register a Dialect
    ...
    */
  override def withDialect(dialect: Dialect): AgentFabricConfiguration = _internal.withDialect(dialect)
  ...
  /** Register a Dialect
    ...
    */
  def withDialect(url: String): ClientFuture[AgentFabricConfiguration] = _internal.withDialect(url).asClient
  ...
  /** Set [[BaseExecutionEnvironment]]
    ...
    */
  override def withExecutionEnvironment(executionEnv: BaseExecutionEnvironment): AgentFabricConfiguration =
  ...
  /** Register a [[Dialect]] linked from a [[DialectInstance]]
    ...
    *   A CompletableFuture of [[AgentFabricConfiguration]]
    */
  def forInstance(url: String): ClientFuture[AgentFabricConfiguration] = _internal.forInstance(url).asClient

  override def withShapePayloadPlugin(plugin: AMFShapePayloadValidationPlugin): AgentFabricConfiguration =
...
@JSExportAll
@JSExportTopLevel("AgentFabricConfiguration")
object AgentFabricConfiguration {

  def AgentFabric(): AgentFabricConfiguration = new AgentFabricConfiguration(InternalAgentFabricConfiguration.AgentFabric())
