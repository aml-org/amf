...
- Source: http://a.ml/vocabularies/amf/parser#exampleError
  Message: {"keyword":"type","dataPath":"","schemaPath":"#/oneOf/0/type","params":{"type":"integer"},"message":"should be integer"}
{"keyword":"minimum","dataPath":"","schemaPath":"#/oneOf/1/minimum","params":{"comparison":">=","limit":2,"exclusive":false},"message":"should be >= 2"}
