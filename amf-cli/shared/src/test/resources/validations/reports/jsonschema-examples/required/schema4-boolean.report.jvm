...
- Source: http://a.ml/vocabularies/amf/parser#invalid-required-value
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/jsonschema/required/schema4-boolean.raml/web-api/end-points/%2Fproducts/put/request/application%2Fjson#/shape/application%2Fjson
  Property: 
