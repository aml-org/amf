...
import amf.plugins.domain.apicontract.metamodel.security.OAuth2SettingsModel._
import amf.plugins.domain.apicontract.metamodel.security.OpenIdConnectSettingsModel._
import amf.plugins.domain.apicontract.metamodel.security.SettingsModel._
