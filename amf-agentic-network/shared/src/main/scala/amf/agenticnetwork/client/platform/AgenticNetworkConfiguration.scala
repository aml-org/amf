...
import amf.agenticnetwork.client.scala.{
  AgenticNetworkBaseUnitClient => InternalAgenticNetworkBaseUnitClient,
  AgenticNetworkConfiguration => InternalAgenticNetworkConfiguration
}
import amf.agenticnetwork.internal.convert.AgenticNetworkClientConverters._
...
@JSExportAll
class AgenticNetworkConfiguration private[amf] (private[amf] override val _internal: InternalAgenticNetworkConfiguration)
    extends BaseAgenticNetworkConfiguration(_internal) {

  /** Contains common AMF graph operations associated to documents */
  override def baseUnitClient(): AMLBaseUnitClient = new AgenticNetworkBaseUnitClient(new InternalAgenticNetworkBaseUnitClient(_internal))
  ...
  /** Set the configuration [[ResourceLoader]]s
    ...
    */
  override def withResourceLoaders(rl: ClientList[ResourceLoader]): AgenticNetworkConfiguration =
  ...
  /** Register a Dialect
    ...
    */
  override def withDialect(dialect: Dialect): AgenticNetworkConfiguration = _internal.withDialect(dialect)
  ...
  /** Register a Dialect
    ...
    */
  def withDialect(url: String): ClientFuture[AgenticNetworkConfiguration] = _internal.withDialect(url).asClient
  ...
  /** Set [[BaseExecutionEnvironment]]
    ...
    */
  override def withExecutionEnvironment(executionEnv: BaseExecutionEnvironment): AgenticNetworkConfiguration =
  ...
  /** Register a [[Dialect]] linked from a [[DialectInstance]]
    ...
    *   A CompletableFuture of [[AgenticNetworkConfiguration]]
    */
  def forInstance(url: String): ClientFuture[AgenticNetworkConfiguration] = _internal.forInstance(url).asClient

  override def withShapePayloadPlugin(plugin: AMFShapePayloadValidationPlugin): AgenticNetworkConfiguration =
...
@JSExportAll
@JSExportTopLevel("AgenticNetworkConfiguration")
object AgenticNetworkConfiguration {

  def AgenticNetwork(): AgenticNetworkConfiguration = new AgenticNetworkConfiguration(InternalAgenticNetworkConfiguration.AgenticNetwork())
