...
class EditingResolutionTest extends BuildCycleTests {
  ...
  val extendsPath     = "parser-client/shared/src/test/resources/resolution/extends/"
  val productionPath  = "parser-client/shared/src/test/resources/production/"
  val resolutionPath  = "parser-client/shared/src/test/resources/resolution/"
  val cyclePath       = "parser-client/shared/src/test/resources/upanddown/"
  val referencesPath  = "parser-client/shared/src/test/resources/references/"
  val validationsPath = "parser-client/shared/src/test/resources/validations/"
