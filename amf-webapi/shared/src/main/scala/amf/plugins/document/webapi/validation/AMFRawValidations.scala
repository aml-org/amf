...
object AMFRawValidations {
  val raw = List(
    ...
    "amf-parser:array-shape-items-mandatory	Declaration of the type of the items for an array is required	OpenAPI	Domain	raml-shapes:ArrayShape	raml-shapes:items	PropertyShape	sh:path	sh:minCount	1	items facet of RAML Array type is required	items property of Schame objects of type 'array' is required",
    "amf-parser:array-shape-items-optional	Declaration of the type of the items for an array is optional	RAML	Domain	raml-shapes:ArrayShape	raml-shapes:items	PropertyShape	sh:path	sh:minCount	0	items facet of RAML Array type is required	items property of Schame objects of type 'array' is required",
    "amf-parser:array-shape-items-optional	Declaration of the type of the items for an array is optional	RAML08	Domain	raml-shapes:ArrayShape	raml-shapes:items	PropertyShape	sh:path	sh:minCount	0	items facet of RAML Array type is required	items property of Schame objects of type 'array' is required",
    ...
    "		AMF	Domain	raml-shapes:ScalarShape	sh:minInclusive	PropertyShape	sh:path	sh:datatype	xsd:double	minimum facet for a RAML scalar type must be a integer	minimum for scalar Schema object of scalar type must be a integer",
    ...
    "		AMF	Domain	raml-shapes:ScalarShape	sh:maxInclusive	PropertyShape	sh:path	sh:datatype	xsd:double	maximum facet for a RAML scalar type must be a integer	maximum for scalar Schema object of scalar type must be a integer",
    ...
    "		AMF	Domain	raml-shapes:ScalarShape	sh:minLength	PropertyShape	sh:path	sh:minInclusive	0	Min length facet should be greater or equal than 0	Min length facet should be greater or equal than 0",
    "		AMF	Domain	raml-shapes:ScalarShape	sh:maxLength	PropertyShape	sh:path	sh:minInclusive	0	Max length facet should be greater or equal than 0	Max length facet should be greater or equal than 0",
    ...
    "		AMF	Domain	raml-shapes:ScalarShape	raml-shapes:multipleOf	PropertyShape	sh:path	sh:datatype	xsd:double	multipleOf facet for a RAML scalar type must be a integer	multipleOf for scalar Schema object of scalar type must be a integer",
