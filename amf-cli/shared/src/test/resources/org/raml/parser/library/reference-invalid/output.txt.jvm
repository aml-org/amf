...
- Constraint: http://a.ml/vocabularies/amf/core#unresolved-reference
  ...
  Severity: Violation
  Target: file://amf-cli/shared/src/test/resources/org/raml/parser/library/reference-invalid/input.raml#/web-api/endpoint/%2Fitems/supportedOperation/get/returns/resp/210/payload/application%2Fcustom/any/schema/inherits/unresolved
  Property: 
  Range: [(10,20)-(10,31)]
