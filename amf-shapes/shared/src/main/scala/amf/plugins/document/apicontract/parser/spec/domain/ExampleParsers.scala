...
import amf.plugins.document.apicontract.parser.spec.{ErrorNamedExample, OasShapeDefinitions}
import amf.plugins.document.apicontract.parser.{RamlWebApiContextType, ShapeParserContext}
