...
object SfdcVersionFactory extends SpecVersionFactory {
...
class SfdcWebApiContext(override val loc: String,
  ...
  override val factory: SpecVersionFactory = SfdcVersionFactory
}
