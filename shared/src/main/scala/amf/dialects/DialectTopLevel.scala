...
object RAML_1_0_DialectTopLevel {
  case class dialectObject(entity: DomainEntity = DomainEntity(DialectDefinition), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class NodeDefinitionObject(entity: DomainEntity = DomainEntity(NodeDefinition), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class PropertyMappingObject(entity: DomainEntity = DomainEntity(PropertyMapping), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class DocumentContentDeclarationObject(entity: DomainEntity = DomainEntity(DocumentEncode), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class DeclarationObject(entity: DomainEntity = DomainEntity(NodeReference), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class ModuleDeclarationObject(entity: DomainEntity = DomainEntity(ModuleDeclaration), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
  ...
  case class FragmentsDeclarationObject(entity: DomainEntity = DomainEntity(FragmentDeclaration), override val parent:Option[TopLevelObject] = None) extends TopLevelObject(entity, parent){
