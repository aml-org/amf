...
- Source: http://a.ml/vocabularies/amf/parser#unsupported-example-media-type-warning
  ...
  Level: Warning
  Target: file://amf-client/shared/src/test/resources/validations/xmlexample/offices_xml_type.raml#/declarations/types/schema/Office/examples/example/default-example
