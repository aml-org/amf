...
private[shape_normalization2] case class AnyShapeAdjuster2(any: AnyShape) {
...
object AnyShapeAdjuster2 {
  def apply(any: AnyShape): AnyShape = new AnyShapeAdjuster2(any).adjust
}
