...
class ValidationTest extends AsyncFunSuite with PlatformSecrets {
  ...
  val vocabulariesPath = "file://parser-client/shared/src/test/resources/vocabularies2/production/validation/"
  val examplesPath     = "file://parser-client/shared/src/test/resources/validations/"
  val productionPath   = "file://parser-client/shared/src/test/resources/production/"
  val validationsPath  = "file://parser-client/shared/src/test/resources/validations/"
  val upDownPath       = "file://parser-client/shared/src/test/resources/upanddown/"
  val parserPath       = "file://parser-client/shared/src/test/resources/org/raml/parser/"
  val jsonSchemaPath   = "file://parser-client/shared/src/test/resources/validations/jsonschema"
  ...
  test("Can normalize a recursive array API") {
    for {
      ...
      assert(
        profile.violationLevel.head == "file://parser-client/shared/src/test/resources/production/recursive2.raml#/declarations/types/array/A_validation")
    }
  }
