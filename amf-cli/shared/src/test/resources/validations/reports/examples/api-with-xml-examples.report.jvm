...
- Constraint: http://a.ml/vocabularies/amf/validation#unsupported-example-media-type-warning
  ...
  Severity: Warning
  Target: file://amf-cli/shared/src/test/resources/validations/api-with-xml-examples/api.raml#/web-api/endpoint/%2Fcontacts/supportedOperation/get/returns/resp/200/payload/application%2Fatom%2Bxml/schema/application%2Fatom%2Bxml/examples/example/default-example
...
- Constraint: http://a.ml/vocabularies/amf/validation#unsupported-example-media-type-warning
  ...
  Severity: Warning
  Target: file://amf-cli/shared/src/test/resources/validations/api-with-xml-examples/api.raml#/web-api/endpoint/%2Fcontacts/supportedOperation/post/returns/resp/201/payload/application%2Fatom%2Bxml/schema/application%2Fatom%2Bxml/examples/example/default-example
  Property: http://a.ml/vocabularies/document#value
  Range: [(1,0)-(1,0)]
  Location: file://amf-cli/shared/src/test/resources/validations/api-with-xml-examples/examples/contact.xml
