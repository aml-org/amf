...
trait DialectInstancesValidationTest extends DialectInstanceValidation with ReportComparison {
  ...
  test("validation dialect 1 example 1 correct") {
    validate("dialect1.raml", "instance1_correct1.raml")
  }

  test("validation of dialect with any type") {
    validate("any_dialect.raml", "any_example.raml")
  }

  test("validation of dialect with any type array") {
    validate("any_array_dialect.raml", "any_array_example.raml")
  }

  test("validation dialect 1b example 1b correct") {
    validate("dialect1b.raml", "example1b.raml")
  }

  test("validation dialect 1 example 1 incorrect") {
    validate("dialect1.raml", "instance1_incorrect1.raml", Some("instance1_incorrect1.report.json"))
  }

  test("validation dialect 2 example 1 correct") {
    validate("dialect2.raml", "instance2_correct1.raml")
  }

  test("validation dialect 2 example 1 incorrect") {
    validate("dialect2.raml", "instance2_incorrect1.raml", Some("instance2_incorrect1.report.json"))
  }

  test("validation dialect 3 example 1 correct") {
    validate("dialect3.raml", "instance3_correct1.raml")
  }

  test("validation dialect 3 example 1 incorrect") {
    validate("dialect3.raml", "instance3_incorrect1.raml", Some("instance3_incorrect1.report.json"))
  }

  test("validation dialect 4 example 1 correct") {
    validate("dialect4.raml", "instance4_correct1.raml")
  }

  test("validation dialect 5 example 1 correct") {
    validate("dialect5.raml", "instance5_correct1.raml")
  }

  test("validation dialect 5 example 1 incorrect") {
    validate("dialect5.raml", "instance5_incorrect1.raml", Some("instance5_incorrect1.report.json"))
  }

  test("validation dialect 6 example 1 correct") {
    validate("dialect6.raml", "instance6_correct1.raml")
  }

  test("validation dialect 6 example 1 incorrect") {
    validate("dialect6.raml", "instance6_incorrect1.raml", Some("instance6_incorrect1.report.json"))
  }

  test("validation dialect 7 example 1 correct") {
    validate("dialect7.raml", "instance7_correct1.raml")
  }

  test("validation dialect 7 example 1 incorrect") {
    validate("dialect7.raml", "instance7_incorrect1.raml", Some("instance7_incorrect1.report.json"))
  }

  test("validation dialect 8 example 1 correct") {
    validate("dialect8a.raml", "instance8_correct1.raml")
  }

  test("validation dialect 8 example 1 incorrect") {
    validate("dialect8a.raml", "instance8_incorrect1.raml", Some("instance8_incorrect1.report.json"))
  }

  test("validation dialect 9 example 1 correct") {
    validate("dialect9.raml", "instance9_correct1.raml")
  }

  test("validation dialect 9 example 1 incorrect") {
    validate("dialect9.raml", "instance9_incorrect1.raml", Some("instance9_incorrect1.report.json"))
  }

  test("validation dialect 10 example 1 correct") {
    validate("dialect10.raml", "instance10_correct1.raml")
  }
  ...
  ignore("validation dialect 10 example 1 incorrect - Dialect ID in comment (instead of key)") {
    recoverToSucceededIf[Exception] { // Unknown type of dialect header
      validate("dialect10.raml", "instance10_incorrect1.raml")
    }
  }

  // TODO: un-ignore when AML re-implements the validation
  ignore("validation dialect 10 example 2 incorrect - Dialect ID in both key and comment") {
    validate("dialect9.raml", "instance9_correct1.raml").flatMap(_ =>
      validate("dialect10.raml", "instance10_incorrect2.raml"))
  ...
  test("custom validation profile for dialect default profile") {
    validateWithCustomProfile("eng_demos_dialect1.raml",
                              "eng_demos_instance1.raml",
                              ProfileName("eng_demos_profile.raml"),
                              "Eng Demos 0.1")
  }
  ...
  test("Can validate asyncapi 0.2 correct") {
    validate("dialect2.raml", "example2.raml", path = s"$productionPath/asyncapi")
  }

  test("Can validate asyncapi 0.3 correct") {
    validate("dialect3.raml", "example3.raml", path = s"$productionPath/asyncapi")
  }

  test("Can validate asyncapi 0.4 correct") {
    validate("dialect4.raml", "example4.raml", path = s"$productionPath/asyncapi")
  }

  test("Can validate container configurations") {
    validate("dialect.raml", "system.raml", path = s"$productionPath/system")
  }
