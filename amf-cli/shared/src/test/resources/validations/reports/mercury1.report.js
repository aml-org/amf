Model: file://amf-cli/shared/src/test/resources/validations/mercury.raml
Profile: mercury
Conforms? false
Number of results: 4
...
- Source: http://a.ml/vocabularies/data#camelcase-query-parameters
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/mercury.raml#/web-api/end-points/%2Fresource%2F%7Bresource_id%7D/get/request/parameter/query/expand_param
  Property: 
  Position: Some(LexicalInformation([(32,16)-(39,0)]))
  Location: file://amf-cli/shared/src/test/resources/validations/mercury.raml
...
- Source: http://a.ml/vocabularies/data#no-todo-text-in-description-fields
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/mercury.raml#/web-api/end-points/%2Fresource%2F%7Bresource_id%7D/post
  Property: 
...
- Source: http://a.ml/vocabularies/data#upper-camelcase-datatype
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/mercury.raml
  Property: 
...
- Source: http://a.ml/vocabularies/data#at-least-one-2xx-or-3xx-response
  ...
  Level: Violation
  Target: file://amf-cli/shared/src/test/resources/validations/mercury.raml#/web-api/end-points/%2Fresource%2F%7Bresource_id%7D/put
