...
import amf.plugins.document.vocabularies2.metamodel.domain.{DatatypePropertyTermModel, ObjectPropertyTermModel}
import amf.plugins.document.vocabularies2.metamodel.domain.ObjectPropertyTermModel._
