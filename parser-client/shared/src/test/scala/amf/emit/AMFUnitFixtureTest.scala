...
trait AMFUnitFixtureTest extends PlatformSecrets {
  ...
  def libraryBare(): Module = {
    Module()
      .withId("file://parser-client/shared/src/test/resources/clients/lib/lib.raml")
      .withLocation("file://parser-client/shared/src/test/resources/clients/lib/lib.raml")
