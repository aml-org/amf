...
class RamlParserErrorTest extends AsyncFunSuite with PlatformSecrets {
  ...
  private val basePath = "file://amf-tests/shared/src/test/resources/error/"
  ...
  test("Custom facets work correctly with the closed node detection mechanism") {
    validate(
      ...
      erroneousTypeShape => {
        ...
        erroneousTypeShape.targetNode should be ("file://amf-tests/shared/src/test/resources/error/custom-facets.raml#/declarations/scalar/ErroneousType")
      ...
      incorrect1 => {
        ...
        incorrect1.targetNode should be ("file://amf-tests/shared/src/test/resources/error/custom-facets.raml#/declarations/union/Incorrect1")
        incorrect1.validationId should be (ParserSideValidations.ClosedShapeSpecification.id())
      },
      incorrect2 => {
        incorrect2.level should be ("Violation")
        incorrect2.targetNode should be ("file://amf-tests/shared/src/test/resources/error/custom-facets.raml#/declarations/union/Incorrect2")
        incorrect2.validationId should be (ParserSideValidations.ClosedShapeSpecification.id())
      },
      incorrect3 => {
        incorrect3.level should be ("Violation")
        incorrect3.targetNode should be ("file://amf-tests/shared/src/test/resources/error/custom-facets.raml#/declarations/union/Incorrect3")
