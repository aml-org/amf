...
import amf.plugins.domain.webapi.metamodel.security.{ApiKeySettingsModel, ParametrizedSecuritySchemeModel}
...
object WebAPIDialects {
  ...
  object OAS20DialectNodes {
    ...
    val ContactObject: NodeMapping = NodeMapping()
    ...
    val LicenseObject: NodeMapping = NodeMapping()
    ...
    val BasicSecuritySchemeObject: NodeMapping = NodeMapping()
    ...
    val ApiKeySecuritySchemeObject: NodeMapping = NodeMapping()
    ...
    val InfoObject: NodeMapping = NodeMapping()
    ...
    val PathObject: NodeMapping = NodeMapping()
      .withId("#/PathObject")
      .withName("PathObject")
    ...
    val WebAPIObject: NodeMapping = NodeMapping()
  ...
  // Dialect
  val OAS20Dialect: Dialect = Dialect()
    .withName("OAS")
    .withVersion("2.0")
